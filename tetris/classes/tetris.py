...
class Tetris:
    def __init__(self):
        ...
        self.bar_width = self.pixel_per_casket * 6
        # game variabels
    ...
    def draw_block(self, x, y, color):
        pygame.draw.rect(self.window, color, ((x + 1) * self.pixel_per_casket, (y + 1) * self.pixel_per_casket, self.pixel_per_casket, self.pixel_per_casket), 3)
